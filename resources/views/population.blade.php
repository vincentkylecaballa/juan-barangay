...
<head>
    ...
    <title>Barangay Population | JuanBarangay</title>
</head>
        ...
        <div class="row">
            <div class="col-lg-3" style="position: fixed">
                <div class="nav-sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <div class="col-md-12">
                                <a class="align-items-center nav-link active" href="/officer"><img class="icon ml-3 mr-3 p-2"
            ...
            <div class="col-lg-9 scrollit">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-9">
                            <h1 class="pt-5">Barangay Population</h1>
                        </div>
                        <div class="col-md-3">
